...
const ImageDetails = async ({ params: { id } }: SearchParamProps) => {
  ...
  const displayHeight = getImageSize(
    ...
    <div className="space-y-8">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-border bg-card shadow-lg">
        <div
          ...
          aria-hidden
        />
        <div className="absolute inset-y-0 right-10 hidden lg:block w-px bg-gradient-to-b from-transparent via-white/30 to-transparent dark:via-white/10" aria-hidden />
        <div className="relative grid gap-8 p-6 lg:p-10 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <h2 className="text-3xl font-bold text-foreground sm:text-4xl">{image.title}</h2>
          ...
          <div className="rounded-2xl border border-border bg-card/80 p-6 shadow-inner space-y-6">
            <div className="flex items-center gap-4">
              <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-violet-500 text-white shadow-lg shadow-blue-500/30">
                ...
                />
                <div className="absolute inset-0 rounded-2xl border border-white/30" aria-hidden />
              </div>
              <div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-xl border border-blue-200/40 dark:border-blue-800/40 bg-gradient-to-br from-blue-500/10 to-indigo-500/10 p-4">
                ...
                <p className="text-lg font-semibold text-foreground mt-2">{createdOn}</p>
                <p className="text-xs text-muted-foreground">Timestamp synced across devices</p>
              </div>
              <div className="rounded-xl border border-slate-200/60 dark:border-slate-700/60 bg-card/70 p-4">
                ...
                <p className="text-xs text-muted-foreground">Optimized for instant downloads</p>
              </div>
            </div>
            <div className="rounded-2xl border border-border bg-muted/40 p-4">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Use the actions below to iterate, duplicate settings, or clean up the output directly in your studio.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h3 className="text-lg font-semibold text-foreground">Transformation Details</h3>
              </div>
            </div>
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div className="group relative rounded-2xl border border-border bg-muted/40 p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="text-xs text-muted-foreground mt-1">Applies preset tuning for this workflow.</p>
            </div>
            ...
            {image.aspectRatio && (
              <div className="group relative rounded-2xl border border-border bg-muted/40 p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                ...
                <p className="text-xl font-semibold text-foreground">{image.aspectRatio}</p>
                <p className="text-xs text-muted-foreground mt-1">Keeps framing consistent between versions.</p>
              </div>
            )}
            ...
            {image.color && (
              <div className="group relative rounded-2xl border border-border bg-muted/40 p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <p className="text-base font-semibold text-foreground">{image.color}</p>
                </div>
                <p className="text-xs text-muted-foreground mt-1">Primary tone influencing diffusion.</p>
              </div>
            )}
            ...
            <div className="group relative rounded-2xl border border-border bg-muted/40 p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="text-xs text-muted-foreground mt-1">High-res export ready for download.</p>
            </div>
            ...
            {image.prompt && (
              <div className="group relative rounded-2xl border border-border bg-gradient-to-br from-purple-500/10 to-indigo-500/10 p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl lg:col-span-2">
                ...
                <p className="text-sm font-medium text-foreground/90 leading-relaxed line-clamp-3" title={image.prompt}>
                  {image.prompt}
                </p>
              </div>
            )}
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border/70 bg-gradient-to-r from-muted/30 via-transparent to-muted/30 px-6 py-5">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 flex-center shadow-md shadow-indigo-500/30">
              <Image src="/assets/icons/image.svg" alt="comparison" width={18} height={18} className="brightness-0 invert" />
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.35em] text-muted-foreground">Review</p>
              <h3 className="text-lg font-semibold text-foreground">Before & After</h3>
            </div>
          </div>
          <div className="flex flex-wrap gap-2">
            <span className="rounded-full border border-border px-3 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-muted-foreground">Live preview</span>
            <span className="rounded-full bg-muted/70 px-3 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-muted-foreground">Hover to inspect</span>
          </div>
        </div>
          ...
          <article className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.35em] text-muted-foreground">Original</p>
              </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-border bg-muted/40 shadow-lg group">
              ...
              <div className="absolute bottom-4 left-4 opacity-0 group-hover:opacity-100 transition-opacity">
                <span className="rounded-xl bg-white/90 px-3 py-1 text-xs font-semibold text-slate-800">Original capture</span>
              </div>
            </div>
            <div className="flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
              <span className="rounded-full border border-border px-3 py-1">{displayWidth} × {displayHeight}px</span>
              <span className="rounded-full border border-border px-3 py-1 capitalize">{image.aspectRatio || "native"}</span>
            </div>
          </article>
          ...
          <article className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.35em] text-muted-foreground">Transformed</p>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-muted-foreground">
              <span className="rounded-full border border-border px-3 py-1 capitalize">{image.transformationType}</span>
              {image.color && (
                <span className="inline-flex items-center gap-2 rounded-full border border-border px-3 py-1">
                  <span className="h-3 w-3 rounded-full" style={{ backgroundColor: image.color }} />
                  {image.color}
                </span>
              )}
            </div>
          ...
          <div className="relative space-y-6 p-6 lg:p-8">
            <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-border/70 bg-white/85 px-5 py-4 shadow-sm backdrop-blur dark:bg-white/5">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 via-indigo-500 to-violet-600 text-white shadow-[0_10px_40px_rgba(79,70,229,0.25)]">
                  <Image src="/assets/icons/stars.svg" alt="manage" width={20} height={20} className="brightness-0 invert" />
                </div>
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.35em] text-muted-foreground">Owner tools</p>
                  <h3 className="text-2xl font-semibold text-foreground">Manage transformation</h3>
                </div>
              </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
              <div className="rounded-2xl border border-border bg-white/90 p-6 shadow-sm backdrop-blur dark:bg-white/5">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <p className="text-xs font-semibold uppercase tracking-[0.3em] text-muted-foreground">Creative maintenance</p>
                    <p className="text-base text-muted-foreground">
                      Update, iterate, or duplicate this transformation straight from your studio.
                    </p>
                  </div>
                ...
                <div className="mt-6">
                  ...
                  >
                    <Link href={`/transformations/${image.id}/update`} className="flex flex-1 items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-slate-800/90 text-white dark:bg-slate-100 dark:text-slate-900">
                          <Image src="/assets/icons/stars.svg" alt="update" width={20} height={20} className="brightness-0 invert dark:invert-0" />
                        </div>
                        <div className="text-left">
                          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-white/70 dark:text-slate-500">Update</p>
                          <p className="text-base font-semibold">Open editor</p>
                        </div>
                      </div>
                      <span className="text-sm font-semibold text-white/80 dark:text-slate-500">⌘ + U</span>
                    </Link>
                  </Button>
                </div>
              </div>
              ...
              <div className="grid gap-4">
                <div className="rounded-2xl border border-border bg-card/90 p-5 shadow-sm">
                  <p className="text-xs font-semibold uppercase tracking-[0.35em] text-muted-foreground">Cleanup</p>
                  <p className="mt-2 text-sm text-muted-foreground">Remove this output from your library when it no longer fits your gallery.</p>
                  <div className="mt-4">
                    <DeleteConfirmation imageId={image.id} />
                  </div>
                </div>
                <div className="rounded-2xl border border-border bg-card/90 p-5 shadow-sm">
                  <p className="text-xs font-semibold uppercase tracking-[0.35em] text-muted-foreground">Quick notes</p>
                  <dl className="mt-4 grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <dt className="text-[11px] uppercase tracking-[0.3em] text-muted-foreground">Credits</dt>
                      <dd className="text-lg font-semibold text-foreground">{image.credits || 0}</dd>
                    </div>
                    <div>
                      <dt className="text-[11px] uppercase tracking-[0.3em] text-muted-foreground">Last run</dt>
                      <dd className="text-lg font-semibold text-foreground">{createdOn}</dd>
                    </div>
                  </dl>
                </div>
              </div>
            ...
            <div className="grid gap-4 md:grid-cols-3 text-sm">
              <div className="rounded-2xl border border-border bg-white/90 p-4 shadow-sm dark:bg-white/5">
                ...
                <p className="text-xs text-muted-foreground">Visible in your library</p>
              </div>
              <div className="rounded-2xl border border-border bg-white/90 p-4 shadow-sm dark:bg-white/5">
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-muted-foreground">Credits used</p>
                <p className="text-lg font-semibold text-foreground">{image.credits || 0}</p>
                <p className="text-xs text-muted-foreground">Based on config</p>
              </div>
              <div className="rounded-2xl border border-border bg-white/90 p-4 shadow-sm dark:bg-white/5">
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-muted-foreground">Last updated</p>
                <p className="text-lg font-semibold text-foreground">{createdOn}</p>
